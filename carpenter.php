...
<body>
<img src="img/service/car1.jpg" alt="Nature" class="responsive" width="1500" height="200">
</body> 
...
<div id="London" class="tabcontent">
  <div class="footer-links" style="margin-left: 40px"><br>
           <span style="background: #994C00;border-radius: 20px;padding: 12px 90px;">Repair & Fixes</span><br><br><br>
           <span style="background: #994C00;border-radius: 20px;padding: 12px 65px;">New Furniture Making</span><br><br><br>
           <span style="background: #994C00;border-radius: 20px;padding: 12px 100px;">Other Wood</span><br><br>
...
<div id="Paris" class="tabcontent">
  <div class=" footer-links" style="margin-left: 40px"><br>
      <?php
        $qry=mysqli_query($con,"select * from service_person2 where category='capentar'");
...
<div id="Tokyo" class="tabcontent">
  <div class="row" style="margin-top: 15px">
     ...
     <div class="col-md-4" align="center">
       <?php $qry1=mysqli_query($con,"select * from service_person2 where category='capentar'");
       ?>
