...
<body>
<img src="img/service/ele2.jpg" alt="Nature" class="responsive" width="1500" height="200">
</body> 
...
<div id="London" class="tabcontent">
  <div class="footer-links" style="margin-left: 40px"><br>
           <span style="background: #FF3333;border-radius: 20px;padding: 12px 125px;">Electricity Breakdown</span><br><br><br>
           <span style="background: #FF3333;border-radius: 20px;padding: 12px 145px;">Electrical Wiring</span><br><br><br>
           <span style="background: #FF3333;border-radius: 20px;padding: 12px 90px;">Energy Efficiency & Solar Power</span><br><br><br>
           <span style="background: #FF3333;border-radius: 20px;padding: 12px 140px;">Computer Repairs</span><br><br><br>
...
<div id="Paris" class="tabcontent">
  <div class=" footer-links" style="margin-left: 40px"><br>
      <?php
        $qry=mysqli_query($con,"select * from service_person2 where category='electrician'");
...
<div class="row" style="margin-top: 15px">
     ...
     <div class="col-md-4" align="center">
       <?php $qry1=mysqli_query($con,"select * from service_person2 where category='electrician'");
       ?>
