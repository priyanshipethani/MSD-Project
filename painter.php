...
<body>
<img src="img/service/painter.jpg" alt="Nature" class="responsive" width="1500" height="200">
</body> 
...
<div id="London" class="tabcontent">
  <div class="footer-links" style="margin-left: 40px"><br>
           <span style="background: #99CCFF;border-radius: 20px;padding: 12px 90px;">House Painting</span><br><br><br>
           <span style="background: #99CCFF;border-radius: 20px;padding: 12px 65px;">Painting & Decorating</span><br><br><br>
           <span style="background: #99CCFF;border-radius: 20px;padding: 12px 90px;">Spray Painting</span><br><br><br>
           <span style="background: #99CCFF;border-radius: 20px;padding: 12px 105px;">Varnishing</span><br><br>
...
<div id="Paris" class="tabcontent">
  <div class=" footer-links" style="margin-left: 40px"><br>
     <?php
        $qry=mysqli_query($con,"select * from service_person2 where category='painter'");
...
<div id="Tokyo" class="tabcontent">
  <div class="row" style="margin-top: 15px">
     ...
     <div class="col-md-4" align="center">
       <?php $qry1=mysqli_query($con,"select * from service_person2 where category='painter'");
       ?>
...
$('.sp_nm').change(function()
  {
    $a=$(this).val();
    $.ajax({
      url:'get_rat_data.php',
      type:'POST',
      data:"name="+a,
      gatatype:'html'
    })
