...
<body>
<img src="img/service/laudry.jpg" alt="Nature" class="responsive" width="1500" height="200">
</body> 
...
<div id="London" class="tabcontent">
  <div class="footer-links" style="margin-left: 40px"><br>
           <span style="background: #000099;border-radius: 20px;padding: 12px 100px;color: white">Dry Cleaning</span><br><br><br>
           <span style="background: #000099;border-radius: 20px;padding: 12px 77px;color: white">Pressing or ironing</span><br><br><br>
           <span style="background: #000099;border-radius: 20px;padding: 12px 90px;color: white">Spot Treatment</span><br><br>
...
<div id="Paris" class="tabcontent">
  <div class=" footer-links" style="margin-left: 40px"><br>
      <?php
        $qry=mysqli_query($con,"select * from service_person2 where category='laundry'");
...
<div id="Tokyo" class="tabcontent">
  <div class="row" style="margin-top: 15px">
     ...
     <div class="col-md-4" align="center">
       <?php $qry1=mysqli_query($con,"select * from service_person2 where category='laundry'");
       ?>
