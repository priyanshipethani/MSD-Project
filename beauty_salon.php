...
<body>
<img src="img/service/beauty1.jpg" alt="Nature" class="responsive" width="1500" height="200">
</body> 

<div class="tab" style="margin-top: 15px">
  <button class="tablinks" onclick="openCity(event, 'London')" style="width: 180px">Category</button>
  <button class="tablinks" onclick="openCity(event, 'Paris')" style="width: 180px">Professionals</button>
...
<div id="London" class="tabcontent">
  <div class="footer-links" style="margin-left: 40px"><br>
           <span style="background: pink;border-radius: 20px;padding: 12px 90px;">Makeup</span><br><br><br>
           <span style="background: pink;border-radius: 20px;padding: 12px 50px;">Massage for Woman</span><br><br><br>
           <span style="background: pink;border-radius: 20px;padding: 12px 80px;">Hairstyling</span><br><br>
...
<div id="Paris" class="tabcontent">
   <div class=" footer-links" style="margin-left: 40px"><br>
      <?php
        $qry=mysqli_query($con,"select * from service_person2 where category='beauty salon'");
        ...
        { $qry2=mysqli_query($con,"select * from user_registration where id='".$row['user_id']."'");
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <h5 style="text-transform: uppercase;"><span style="font-weight: bold;">Address :-</span><?php echo $row2['address'];?></h5>
              <h5 style="text-transform: uppercase;"><span style="font-weight: bold;">Phone :-</span><?php echo $row2['phone'];?></h5>
              <h5 style="text-transform: uppercase;"><span style="font-weight: bold;">Description :-</span><?php echo $row['description'];?></h5>
              <h5 style="text-transform: uppercase;"><span style="font-weight: bold;">Price :-</span><?php echo $row['price'];?></h5>
...
<div id="Tokyo" class="tabcontent">
  <div class="row" style="margin-top: 15px">
     ...
     <div class="col-md-4" align="center">
       <?php $qry1=mysqli_query($con,"select * from service_person2 where category='beauty salon'");
       ?>
       <select class="form-control" style="width: 100%; background-color: grey;color: black" id='sp_nm'>
         <option value="0">Selct Person</option>
         <?php 
