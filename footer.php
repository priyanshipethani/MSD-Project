       ...
       <div class="row">
         ...
         <div class="col-lg-3 col-md-6 footer-links">
           ...
           <ul>
             ...
             <li><i class="ion-ios-arrow-right"></i> <a href="index.php">Services</a></li>
         ...
         <div class="col-lg-3 col-md-6 footer-contact">
           ...
           <div class="social-links">
             ...
             <a href="https://instagram.com/msd.2647?igshid=1rcdpaf3ttvq0" class="instagram"><i class="fa fa-instagram"></i></a>
