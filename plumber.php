...
<body>
<img src="img/service/plumber1.jpg" alt="Nature" class="responsive" width="1500" height="200">
</body> 
...
<div id="London" class="tabcontent">
  <div class="footer-links" style="margin-left: 40px"><br>
           <span style="background: #FF9933;border-radius: 20px;padding: 12px 100px;">Water leakages</span><br><br><br>
           <span style="background: #FF9933;border-radius: 20px;padding: 12px 85px;">Pipe & Tape fittings</span><br><br><br>
           <span style="background: #FF9933;border-radius: 20px;padding: 12px 100px;">Repair & Fixes</span><br><br>
...
<div class=" footer-links" style="margin-left: 40px"><br>
      <?php
        $qry=mysqli_query($con,"select * from service_person2 where category='plumber'");
...
<div id="Tokyo" class="tabcontent" style="margin-left: 100px">
  
   <div class="row" style="margin-top: 15px">
     <div class="col-md-3"></div>
     <div class="col-md-4" align="center">
       <?php $qry1=mysqli_query($con,"select * from service_person2 where category='plumber'");
       ?>
