...
<body>
<img src="img/service/grocery.jpg" alt="Nature" class="responsive" width="1500" height="200">
</body> 
...
<div id="London" class="tabcontent">
  <div class="footer-links" style="margin-left: 40px"><br>
           <span style="background: #606060;border-radius: 20px;padding: 12px 120px;">Dairy Products</span><br><br><br>
           <span style="background: #606060;border-radius: 20px;padding: 12px 122px;">Frozen Foods</span><br><br><br>
           <span style="background: #606060;border-radius: 20px;padding: 12px 80px;">Non Alcoholic Beverages</span><br><br>
...
<div id="Paris" class="tabcontent">
  <div class=" footer-links" style="margin-left: 40px"><br>
      <?php
        $qry=mysqli_query($con,"select * from service_person2 where category='grocery'");
...
<div class="row" style="margin-top: 15px">
     ...
     <div class="col-md-4" align="center">
       <?php $qry1=mysqli_query($con,"select * from service_person2 where category='grocery'");
       ?>
