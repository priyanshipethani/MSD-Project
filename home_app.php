...
<body>
<img src="img/service/home2.jpg" alt="Nature" class="responsive" width="1500" height="200">
</body> 
...
<div id="London" class="tabcontent">
  <div class="footer-links" style="margin-left: 40px"><br>
           <span style="background: #404040;border-radius: 20px;padding: 12px 90px;">AC & washing machine Rapairs</span><br><br><br>
           <span style="background: #404040;border-radius: 20px;padding: 12px 160px;">TV Repairs</span><br><br><br>
           <span style="background: #404040;border-radius: 20px;padding: 12px 150px;">Fridge Repairs</span><br><br>
...
<div id="Paris" class="tabcontent">
  <div class=" footer-links" style="margin-left: 40px"><br>
      <?php
        $qry=mysqli_query($con,"select * from service_person2 where category='home appliances'");
...
<div id="Tokyo" class="tabcontent">
 <div class="row" style="margin-top: 15px">
     ...
     <div class="col-md-4" align="center">
       <?php $qry1=mysqli_query($con,"select * from service_person2 where category='home appliances'");
       ?>
